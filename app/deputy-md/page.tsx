...
export default function ManagingDirectorProfile() {
    const profile = {
        ...
        bio: [
            [
                { text: "Since 2012, ", normal: true },
                { text: "Architect Md Mamunur Rahman (Munim)", highlight: true, bold: true },
                { text: " has been actively engaged in the Real Estate Industry, bringing with him extensive expertise, deep sincerity, and unwavering dedication. He is one of the owners and business partners of ", normal: true },
                { text: "BIO", highlight: true, color: "#7AA859", bold: true, },
                { text: "BUILD Development Ltd", normal: true},
                { text: ". At the company’s inception, he served as Director and Chief Executive Officer (CEO). In response to the company’s growth and evolving operational needs, he assumed the vital role of DEPUTY MANAGING DIRECTOR (DMD).", normal: true }
            ],
            [
                { text: "This is not a contractual employment role, but rather a reflection of his ownership and strategic responsibility as a key partner in the business.", normal: true },
                { text: "His vision is to position",},
                { text: ".", normal: true }
            ],
            [
